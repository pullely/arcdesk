...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Arcdesk web console.
...
- Per-env Cloudflare Pages projects: `arcdesk-web-console-next-{dev,stage,prod}`
