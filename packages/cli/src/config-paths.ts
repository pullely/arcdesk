...
//   - `~/.config/arcdesk/credentials.json` (0600)
//   - `~/.config/arcdesk/config.json`     (0644)
//
// Override via `ARCDESK_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/arcdesk` everywhere
