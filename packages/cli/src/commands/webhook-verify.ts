// `arcdesk webhook verify` — local cryptographic verification of a
// Arcdesk outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `arcdesk login`.
