...
// `@saas/sdk` client class name (`Arcdesk`) is intentionally NOT part of
...
export const CLI_BIN = "arcdesk";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Arcdesk";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.arcdesk.app";
