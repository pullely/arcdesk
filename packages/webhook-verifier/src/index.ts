 ...
 * signature verifier for Arcdesk outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Arcdesk webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Arcdesk webhook delivery.
 *
