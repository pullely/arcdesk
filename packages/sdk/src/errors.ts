// Typed error hierarchy for the Arcdesk SDK.
//
...
// codes (forward compatibility) fall back to the generic `ArcdeskError`
...
export interface ArcdeskErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof ArcdeskError`
 * still matches.
 */
export class ArcdeskError extends Error {
  ...
  constructor(init: ArcdeskErrorInit) {
    super(init.envelope.message);
    this.name = "ArcdeskError";
...
export class BadRequestError extends ArcdeskError {
  constructor(init: ArcdeskErrorInit) {
    super(init);
...
export class UnauthenticatedError extends ArcdeskError {
  constructor(init: ArcdeskErrorInit) {
    super(init);
...
export class ForbiddenError extends ArcdeskError {
  constructor(init: ArcdeskErrorInit) {
    super(init);
...
export class NotFoundError extends ArcdeskError {
  constructor(init: ArcdeskErrorInit) {
    super(init);
...
export class ConflictError extends ArcdeskError {
  constructor(init: ArcdeskErrorInit) {
    super(init);
...
export class ValidationError extends ArcdeskError {
...
export class PreconditionFailedError extends ArcdeskError {
  constructor(init: ArcdeskErrorInit) {
    super(init);
...
export class UnsupportedError extends ArcdeskError {
  constructor(init: ArcdeskErrorInit) {
    super(init);
...
export class InternalError extends ArcdeskError {
  constructor(init: ArcdeskErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends ArcdeskErrorInit {
...
export class RateLimitError extends ArcdeskError {
...
/**
 * Decode an HTTP `Response` into the appropriate `ArcdeskError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `ArcdeskError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new ArcdeskError(init);
  }
}

function decodeRateLimit(
  init: ArcdeskErrorInit,
  response: Response,
): RateLimitError {
