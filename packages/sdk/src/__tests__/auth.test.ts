...
//   - ArcdeskError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): Arcdesk {
  return new Arcdesk({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the Arcdesk class", () => {
