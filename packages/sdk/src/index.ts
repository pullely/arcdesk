// `@saas/sdk` — Arcdesk TypeScript SDK.
//
// Stable public surface:
//   - `Arcdesk`              → the client class
...
// integration path is the `Arcdesk` class.
...
export class Arcdesk {
  ...
  constructor(options: ClientOptions) {
    ...
    this.arc = new ArcClient(this.transport);
